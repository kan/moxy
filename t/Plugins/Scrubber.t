...
eval "use HTML::Scrubber";
plan skip_all => "this test requires HTML::Scrubber" if $@;
plan tests => 1*blocks;
...
--- expected
<html><body><marquee>foo</marquee></body></html>

===
--- input
<html><head><link rel="stylesheet" href="/style.css" type="text/css" /></head><body></body></html>
--- expected
<html><head><link rel="stylesheet" type="text/css"></head><body></body></html>
